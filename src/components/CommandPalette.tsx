          ...
          <Command.List className="max-h-[420px] overflow-auto p-2">
            ...
            <Command.Group heading="Account" className="px-2 py-2 text-xs text-[color:var(--color-text-muted)]">
              ...
              <Command.Item
                ...
                onSelect={() => {
                  setOpen(false)
                  appendToDraftPrompt('/openai-login')
                }}
                className="cursor-pointer rounded-xl px-3 py-2 text-sm hover:bg-slate-100"
              >
                <div className="font-mono">/openai-login</div>
                <div className="text-xs text-[color:var(--color-text-muted)]">Connect OpenAI account</div>
              </Command.Item>
              <Command.Item
                value="openai-login-status"
                onSelect={() => {
                  setOpen(false)
                  appendToDraftPrompt('/openai-login status')
                }}
                className="cursor-pointer rounded-xl px-3 py-2 text-sm hover:bg-slate-100"
              >
                <div className="font-mono">/openai-login status</div>
                <div className="text-xs text-[color:var(--color-text-muted)]">Check OpenAI login status</div>
              </Command.Item>
              <Command.Item
                value="openai-login-logout"
                onSelect={() => {
                  setOpen(false)
                  appendToDraftPrompt('/openai-login logout')
                }}
                className="cursor-pointer rounded-xl px-3 py-2 text-sm hover:bg-slate-100"
              >
                <div className="font-mono">/openai-login logout</div>
                <div className="text-xs text-[color:var(--color-text-muted)]">Disconnect OpenAI account</div>
              </Command.Item>
            </Command.Group>
