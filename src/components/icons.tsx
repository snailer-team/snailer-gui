export function IconChatBubble({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none">
      <path
        d="M20 12c0 4-3.6 7-8 7-1 0-2-.1-2.8-.4L4 20l1.6-3.7C4.6 15.2 4 13.7 4 12c0-4 3.6-7 8-7s8 3 8 7Z"
        stroke="currentColor"
        strokeWidth="1.6"
...
export function IconFolder({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none">
      <path
        d="M3.5 7.5a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-16a2 2 0 0 1-2-2v-10Z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
...
export function IconSliders({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none">
      <path
        d="M4 7h10M18 7h2M14 7v0M4 17h2M8 17h12M8 17v0"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
...
export function IconUser({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none">
      <path
        d="M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8ZM20 20c0-4-3.6-7-8-7s-8 3-8 7"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
        strokeLinejoin="round"
